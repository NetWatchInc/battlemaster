...
export class Labeler {
	...
	/**
	 * Private constructor for the Labeler class.
	 *
	...
	/**
	 * Initializes the Labeler instance.
	...
	/**
	 * Performs graceful shutdown of the Labeler instance.
	 */
